...
- **[general-deploy]** Reuse: already know to use tar pipe + gh auth setup-git (from deploy-cv-it1st)
- **[general-deploy]** PM2 is the simplest process manager for Node.js apps on hummingbot

## Benchmarks

- **Deploy time with prior knowledge:** 5 minutes (67% faster than first deploy) (by general-deploy)
