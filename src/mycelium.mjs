...
export class DynamicAnt {
  constructor(provider, rhizo) { this.provider = provider; this.rhizo = rhizo; }
...
export class ArmyAnt {
  constructor(provider, rhizo, registry) { this.provider = provider; this.rhizo = rhizo; this.registry = registry; }
